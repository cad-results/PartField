#!/bin/bash
# ==============================================================================
# VARIANT 7: Fixed 5 clusters + Self-aligned BREP bounding boxes (STEP)
# ==============================================================================
...
CLUSTERING_DIR="${EXP_DIR}/clustering/variant7_fixed5_self_brep"
BREP_DIR="${EXP_DIR}/brep/variant7_fixed5_self_brep"

FIXED_CLUSTERS=5

echo "========================================================="
echo "VARIANT 7: Fixed ${FIXED_CLUSTERS} clusters + Self-aligned BREP (STEP)"
echo "========================================================="
...
# ==============================================================================
# STEP 3: Generate self-aligned BREP bounding boxes (STEP output)
# ==============================================================================
echo ""
echo "STEP 3: Generating self-aligned BREP bounding boxes..."
echo "-------------------------------------------------------"
...
for glb_file in "${INPUT_DIR}"/*.glb; do
    if [ -f "$glb_file" ]; then
        ...
        if [ -f "$label_file" ]; then
            output_file="${BREP_DIR}/${basename}_${FIXED_CLUSTERS}_brep.step"
