#!/bin/bash
# ==============================================================================
# VARIANT 2: Auto-segmented clusters + Globally-aligned bounding boxes
# ==============================================================================
...
CLUSTERING_DIR="${EXP_DIR}/clustering/variant2_auto_global"
BBOX_DIR="${EXP_DIR}/bboxes/variant2_auto_global"

echo "================================================"
echo "VARIANT 2: Auto-segmented + Globally-aligned BBox"
echo "================================================"
...
# ==============================================================================
echo ""
echo "STEP 3: Generating globally-aligned bounding boxes..."
echo "------------------------------------------------------"
...
PYEOF
        ...
        if [ -f "$label_file" ]; then
            ...
            output_file="${BBOX_DIR}/${basename}_${best_n}_bbox_global.ply"
...
echo ""
echo "Key difference from Variant 1:"
