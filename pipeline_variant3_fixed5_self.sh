#!/bin/bash
# ==============================================================================
# VARIANT 3: Fixed 5 clusters + Self-aligned bounding boxes
# ==============================================================================
...
CLUSTERING_DIR="${EXP_DIR}/clustering/variant3_fixed5_self"
BBOX_DIR="${EXP_DIR}/bboxes/variant3_fixed5_self"

FIXED_CLUSTERS=5

echo "=============================================="
echo "VARIANT 3: Fixed 5 clusters + Self-aligned BBox"
echo "=============================================="
...
# For fixed clusters, we set max_num_clusters to FIXED_CLUSTERS+1
# so it only generates up to that count, then we only use the 5-cluster result
...
# Find and display only the 5-cluster results
...
# ==============================================================================
echo ""
echo "STEP 3: Generating self-aligned bounding boxes for ${FIXED_CLUSTERS} clusters..."
echo "----------------------------------------------------------------------------------"
...
echo "  BBox:     Self-aligned (per-segment PCA orientation)"
echo ""
